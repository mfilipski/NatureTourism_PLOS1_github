$TITLE LEWIE MODEL Lower Zambezi & South Luangwa
...
$setglobal data_input "base_inputsheet_wb_zambia_v15"
*$setglobal data_input "AQ_LEWIE_InputSheet"
* name of index sheet (village-specific):
$setglobal input_sheet_index "Index_SL!A2"
* name file containing simulation dashboard - !!!!!!!!!!  different dashboards for LZ ans SL in Zambia !!!!!
$setglobal sim_dashboard "FAO_SimDashBoard_SL"
...
$setglobal output_txt_file "WB_LEWIE_output"
* name of intermediate SAM output:
$setglobal autosam_file "AutoSAM_WB.xlsx"
* cell where intermediate SAM has bottom right corner:
$setglobal matcorner "AB28"
* name of excel output automatically populated
$setglobal output_xl_file "WB_LEWIE_AutoOut.xlsx"
