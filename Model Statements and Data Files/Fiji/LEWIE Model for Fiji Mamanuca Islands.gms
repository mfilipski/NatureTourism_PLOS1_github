$TITLE LEWIE MODEL Fiji Mamanuca Islands
...
*$setglobal data_input "base_inputsheet_wb_Fiji_v3_mf"
*$setglobal data_input "base_inputsheet_wb_Fiji_v7_touristtrimmed_mf_tests"
*$setglobal data_input "base_inputsheet_wb_Fiji_v8_touristtrimmed_mf"
*$setglobal data_input "base_inputsheet_wb_Fiji_v9_mf"
*$setglobal data_input "base_inputsheet_wb_Fiji_v11"
*$setglobal data_input "base_inputsheet_wb_Fiji_v11bis_hz"
$setglobal data_input "base_inputsheet_wb_Fiji_v13"

* name of index sheet (village-specific):
$setglobal input_sheet_index "Index_FJ!A2"
* name file containing simulation dashboard
$setglobal sim_dashboard "FAO_SimDashboard_Fiji"
* name of include file containing village-specific assumptions
$setglobal assumptions_file  "2_MarketAssumptions_Fiji.gms"
* name of output file for text output:
$setglobal output_txt_file "Fiji_LEWIE_output"
* name of intermediate SAM output:
$setglobal autosam_file "AutoSAM_Fiji.xlsx"
* cell where intermediate SAM has bottom right corner:
$setglobal matcorner "ak37"
* name of excel output automatically populated
$setglobal output_xl_file "Fiji_LEWIE_AutoOut.xlsx"
...
$include End_Output_to_excel.gms
